...
void REGISTER_WRITE_16_request_callback(
...
int main(int argc, char const* argv[]) {
    ...
    core.addController(&ethernetController, syndesi::Network::ControllerType::ETHERNET);
    ethernetController.init();
    core.callbacks.REGISTER_WRITE_16_request_callback = REGISTER_WRITE_16_request_callback;
